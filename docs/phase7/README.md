...
> ## Canonical status
>
> **📝 Planning complete. No code written yet.** `prd.md`, `design.md`, `decisions.md`, and
> `milestone-plan.md` (M1–M8) all exist, produced through a scope-brainstorm and codebase-audit
> pass with the repo owner. M1 (`athena-emulator`: proxy, auth, quirks) is next, not started.
>
...
>   acceptance criteria.
> - [`design.md`](./design.md) — architecture, component breakdown, the precedence-policy and
>   RxNorm term-type-matching sketches, the reconciled-line data model.
> - [`decisions.md`](./decisions.md) — the ADR-style index (`R1`–`R14`), same convention as
>   Phase 2/3/4/6.
> - [`milestone-plan.md`](./milestone-plan.md) — M1–M8, short and long story for each, none
>   started.
...
## Relationship to Phase 1, 2, and 4
...
through Phase 4 — is built out for the first time in this phase (R2).

## Terminology

Internal work is tracked as **milestones** (M1–M8, in `milestone-plan.md`) — never "Phase 7.x",
